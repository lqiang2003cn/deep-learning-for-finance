...
plt.grid()
# Show the plot
plt.savefig("../01_pngs/ch03_03_normal.png")
plt.close()
...
# cpi.to_pickle("../00_data/ch03_03_cpi.pickle")
cpi = pd.read_pickle("../00_data/ch03_03_cpi.pickle")
...
fig, ax = plt.subplots()
# bins: sort the data and divide them into 10 bins.
...
plt.legend()
# Showing the plot
plt.savefig("../01_pngs/ch03_03_skew.png")
plt.close()
